...
public class KalanBlock extends Block {
    private static final RegistryKey<DamageType> KALAN_BURN = RegistryKey.of(RegistryKeys.DAMAGE_TYPE,
            new Identifier("ubesdelight", "kalan_burn"));
    ...
    public void onSteppedOn(World world, BlockPos pos, BlockState state, Entity entity) {
        ...
        if (isLit && !entity.isFireImmune() && entity instanceof LivingEntity livingEntity) {
            if (!EnchantmentHelper.hasFrostWalker(livingEntity)) {
                entity.damage(world.getDamageSources().create(KALAN_BURN), 1.0F);
            }
        }
