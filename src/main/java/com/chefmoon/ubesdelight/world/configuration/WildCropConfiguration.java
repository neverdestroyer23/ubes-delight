package com.chefmoon.ubesdelight.world.configuration;
...
public record WildCropConfiguration (
        ...
        RegistryEntry<PlacedFeature> tertiaryFeature,
    ...
    public static final Codec<WildCropConfiguration> CODEC = RecordCodecBuilder.create((config) -> config.group(
            ...
            PlacedFeature.REGISTRY_CODEC.fieldOf("tertiary_feature").forGetter(WildCropConfiguration::tertiaryFeature),
    ...
    ).apply(config, (tries, xzSpread, yspread, primary, secondary, tertiary, floor) -> floor.map(placedFeatureHolder -> new WildCropConfiguration(tries, xzSpread, yspread, primary, secondary, tertiary, placedFeatureHolder)).orElseGet(() -> new WildCropConfiguration(tries, xzSpread, yspread, primary, secondary, tertiary, null))));
    ...
    public RegistryEntry<PlacedFeature> tertiaryFeature() {
